...
const uid2name = (uid) => uid.split('/').pop().replace(/-/g, ' ').replace(/\b\w/g, c => c.toUpperCase());

// ─── Test UIDs ───────────────────────────────────────────────────────────────

const BACKEND_UIDS = [
  'auth/login-valid-credentials', 'auth/login-invalid-password', 'auth/login-locked-account',
  'auth/logout', 'auth/refresh-token', 'auth/forgot-password', 'auth/reset-password',
  'users/create', 'users/get-by-id', 'users/update-profile', 'users/delete',
  'users/list', 'users/search', 'users/update-password', 'users/get-permissions',
  'orders/create', 'orders/get-by-id', 'orders/update-status', 'orders/cancel',
  'orders/list-by-user', 'orders/apply-coupon', 'orders/calculate-total',
  'orders/validate-items', 'orders/get-tracking',
  'payments/process-credit-card', 'payments/process-paypal', 'payments/refund',
  'payments/status-check', 'payments/recurring-billing', 'payments/payment-history',
  'products/get-details', 'products/list', 'products/search', 'products/filter-by-category',
  'products/create', 'products/update', 'products/delete',
  'products/check-availability', 'products/update-price',
  'cart/add-item', 'cart/remove-item', 'cart/update-quantity',
  'cart/get', 'cart/clear', 'cart/apply-discount', 'cart/checkout',
  'reviews/create', 'reviews/get-by-product', 'reviews/update',
  'reviews/delete', 'reviews/moderate',
  'inventory/check-stock', 'inventory/reserve', 'inventory/release', 'inventory/update',
  'notifications/send-email', 'notifications/send-sms',
  'notifications/get-preferences', 'notifications/update-preferences',
  'search/full-text', 'search/filtered', 'search/suggestions', 'search/recent',
  'analytics/page-views', 'analytics/conversion-rate',
  'analytics/user-sessions', 'analytics/revenue', 'analytics/top-products',
  'admin/dashboard-stats', 'admin/user-management',
  'admin/order-management', 'admin/product-management', 'admin/reports',
];

const FRONTEND_UIDS = [
  'components/Button/renders-primary', 'components/Button/renders-disabled', 'components/Button/handles-click',
  'components/Input/renders-with-placeholder', 'components/Input/validates-required', 'components/Input/validates-email',
  'components/Modal/opens-on-trigger', 'components/Modal/closes-on-escape', 'components/Modal/closes-on-backdrop-click',
  'components/Table/renders-data', 'components/Table/sorts-columns', 'components/Table/paginates',
  'components/Form/submits-correctly', 'components/Form/shows-validation-errors',
  'pages/Login/renders-form', 'pages/Login/validates-email', 'pages/Login/validates-password',
  'pages/Login/submits-login', 'pages/Login/shows-error-on-failure',
  'pages/Register/renders-form', 'pages/Register/validates-fields',
  'pages/Register/submits-registration', 'pages/Register/shows-success',
  'pages/Dashboard/renders-widgets', 'pages/Dashboard/loads-data',
  'pages/Products/renders-list', 'pages/Products/filters-by-category',
  'pages/Products/searches-products', 'pages/Products/shows-product-detail',
  'pages/Cart/adds-to-cart', 'pages/Cart/updates-quantity',
  'pages/Cart/removes-item', 'pages/Cart/shows-total',
  'pages/Checkout/renders-form', 'pages/Checkout/validates-address',
  'pages/Checkout/selects-payment', 'pages/Checkout/places-order',
  'pages/Orders/renders-list', 'pages/Orders/shows-order-detail', 'pages/Orders/tracks-order',
  'pages/Profile/renders-info', 'pages/Profile/updates-profile', 'pages/Profile/changes-password',
  'pages/Admin/renders-dashboard', 'pages/Admin/manages-users',
  'pages/Admin/manages-products', 'pages/Admin/views-reports',
  'navigation/header-renders', 'navigation/footer-renders',
  'navigation/mobile-menu-opens', 'navigation/breadcrumbs-show', 'navigation/404-page-renders',
  'theme/dark-mode-toggle', 'theme/responsive-mobile', 'theme/responsive-tablet',
  'accessibility/login-keyboard-nav', 'accessibility/form-aria-labels',
  'accessibility/modal-focus-trap', 'accessibility/color-contrast',
  'performance/initial-load-time',
];

const E2E_UIDS = [
  'flows/user-registration-complete', 'flows/login-and-browse',
  'flows/add-to-cart-and-checkout', 'flows/payment-with-credit-card',
  'flows/payment-with-paypal', 'flows/order-tracking', 'flows/cancel-order',
  'flows/write-product-review', 'flows/search-and-filter-products',
  'flows/apply-coupon-code', 'flows/guest-checkout', 'flows/registered-checkout',
  'flows/admin-login', 'flows/admin-add-product',
  'flows/admin-manage-orders', 'flows/admin-manage-users',
  'flows/forgot-password-flow', 'flows/email-verification',
  'flows/social-login-google', 'flows/profile-update',
  'smoke/homepage-loads', 'smoke/login-works', 'smoke/products-load',
  'smoke/cart-works', 'smoke/checkout-initiates',
  'regression/login-after-session-expire', 'regression/cart-persists-across-sessions',
  'regression/order-status-updates', 'regression/payment-retry', 'regression/concurrent-users',
  'integration/payment-gateway', 'integration/email-service',
  'integration/inventory-sync', 'integration/analytics-tracking', 'integration/search-indexing',
  'cross-browser/chrome-checkout', 'cross-browser/firefox-checkout',
  'cross-browser/safari-checkout', 'cross-browser/mobile-checkout', 'cross-browser/edge-checkout',
];

// ─── Relation mappings ────────────────────────────────────────────────────────

const BACKEND_META = {
  'auth/':          { component: 'auth-service',          team: 'platform-team',  tag: 'security' },
  'users/':         { component: 'user-service',          team: 'platform-team',  tag: 'core' },
  'orders/':        { component: 'order-service',         team: 'commerce-team',  tag: 'transactional' },
  'payments/':      { component: 'payment-service',       team: 'commerce-team',  tag: 'critical' },
  'products/':      { component: 'product-service',       team: 'commerce-team',  tag: 'catalog' },
  'cart/':          { component: 'cart-service',          team: 'commerce-team',  tag: 'transactional' },
  'reviews/':       { component: 'review-service',        team: 'commerce-team',  tag: 'social' },
  'inventory/':     { component: 'inventory-service',     team: 'infra-team',     tag: 'critical' },
  'notifications/': { component: 'notification-service',  team: 'infra-team',     tag: 'async' },
  'search/':        { component: 'search-service',        team: 'infra-team',     tag: 'performance' },
  'analytics/':     { component: 'analytics-service',     team: 'platform-team',  tag: 'reporting' },
  'admin/':         { component: 'admin-service',         team: 'platform-team',  tag: 'admin' },
};

const FRONTEND_META = {
  'components/Button':   { component: 'ui-components',    team: 'frontend-team',  tag: 'unit' },
  'components/Input':    { component: 'ui-components',    team: 'frontend-team',  tag: 'unit' },
  'components/Modal':    { component: 'ui-components',    team: 'frontend-team',  tag: 'unit' },
  'components/Table':    { component: 'ui-components',    team: 'frontend-team',  tag: 'unit' },
  'components/Form':     { component: 'ui-components',    team: 'frontend-team',  tag: 'unit' },
  'pages/Login':         { component: 'auth-pages',       team: 'frontend-team',  tag: 'integration' },
  'pages/Register':      { component: 'auth-pages',       team: 'frontend-team',  tag: 'integration' },
  'pages/Dashboard':     { component: 'dashboard-pages',  team: 'frontend-team',  tag: 'integration' },
  'pages/Products':      { component: 'product-pages',    team: 'frontend-team',  tag: 'integration' },
  'pages/Cart':          { component: 'cart-pages',       team: 'frontend-team',  tag: 'integration' },
  'pages/Checkout':      { component: 'checkout-pages',   team: 'frontend-team',  tag: 'integration' },
  'pages/Orders':        { component: 'order-pages',      team: 'frontend-team',  tag: 'integration' },
  'pages/Profile':       { component: 'profile-pages',    team: 'frontend-team',  tag: 'integration' },
  'pages/Admin':         { component: 'admin-pages',      team: 'frontend-team',  tag: 'integration' },
  'navigation/':         { component: 'navigation',       team: 'design-team',    tag: 'layout' },
  'theme/':              { component: 'theming',          team: 'design-team',    tag: 'visual' },
  'accessibility/':      { component: 'accessibility',    team: 'design-team',    tag: 'a11y' },
  'performance/':        { component: 'performance',      team: 'frontend-team',  tag: 'perf' },
};

const E2E_META = {
  'flows/':         { component: 'user-flows',     team: 'qa-team',          tag: 'e2e' },
  'smoke/':         { component: 'smoke-tests',    team: 'qa-team',          tag: 'smoke' },
  'regression/':    { component: 'regression',     team: 'automation-team',  tag: 'regression' },
  'integration/':   { component: 'integration',    team: 'automation-team',  tag: 'integration' },
  'cross-browser/': { component: 'cross-browser',  team: 'qa-team',          tag: 'compatibility' },
};
...
function getCustomMeta(uid, type, idx) {
  if (type === 'e2e') {
    const keys = Object.keys(CUSTOM_META_E2E).sort((a, b) => b.length - a.length);
    let base = { Feature: 'Auth', Priority: 'P2' };
    for (const key of keys) {
      if (uid.startsWith(key)) { base = CUSTOM_META_E2E[key]; break; }
    }
    return {
  ...
  if (type === 'frontend') {
    const keys = Object.keys(CUSTOM_META_FRONTEND).sort((a, b) => b.length - a.length);
    let base = { Feature: 'UI Components', Priority: 'P2' };
    for (const key of keys) {
      if (uid.startsWith(key)) { base = CUSTOM_META_FRONTEND[key]; break; }
    }
    return {
...
function buildStabilityMap(uids, seed) {
  ...
  uids.forEach((uid) => {
    const roll = r();
    let stability;
    if (roll < 0.55)      stability = { type: 'stable',   basePass: 0.96 + r() * 0.03 };
    else if (roll < 0.80) stability = { type: 'moderate', basePass: 0.82 + r() * 0.12 };
    else if (roll < 0.93) stability = { type: 'flaky',    basePass: 0.50 + r() * 0.25 };
    else                  stability = { type: 'broken',   basePass: 0.05, fixedAtBuild: randInt(8, 18) };
    map[uid] = stability;
  });
  return map;
}
...
function buildQuality(buildIndex) {
  ...
  return Math.min(0.99, Math.max(0.40, base + noise));
}
...
const BACKEND_STEP_CONFIG = {
  'auth/': {
    ...
    successBody: { token: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.demo', expiresIn: 3600, tokenType: 'Bearer' },
    failBody: { error: 'Unauthorized', message: 'Invalid credentials or session expired', code: 401 },
    assertions: [
  ...
  'users/': {
    ...
    successBody: { id: 'usr_demo123', email: 'test@acme.io', role: 'customer', createdAt: '2024-01-15T10:00:00Z' },
    failBody: { error: 'Not Found', message: 'User record does not exist', code: 404 },
    assertions: [
  ...
  'orders/': {
    ...
    successBody: { orderId: 'ord_demo456', status: 'confirmed', total: 149.99, currency: 'USD', items: 3 },
    failBody: { error: 'Unprocessable Entity', message: 'Order validation failed: item quantity exceeds stock', code: 422 },
    assertions: [
  ...
  'payments/': {
    ...
    successBody: { transactionId: 'txn_demo789', status: 'succeeded', amount: 149.99, currency: 'USD', gateway: 'stripe' },
    failBody: { error: 'Payment Failed', message: 'Card declined: insufficient funds', code: 402, declineCode: 'insufficient_funds' },
    assertions: [
  ...
  'products/': {
    ...
    successBody: { id: 'prod_demo001', name: 'Demo Widget Pro', price: 49.99, stock: 250, category: 'electronics' },
    failBody: { error: 'Not Found', message: 'Product not found in catalog', code: 404 },
    assertions: [
  ...
  'cart/': {
    ...
    successBody: { cartId: 'cart_demo321', items: [{ productId: 'prod_001', qty: 2, price: 49.99 }], total: 99.98 },
    failBody: { error: 'Bad Request', message: 'Cannot add item: product is out of stock', code: 400 },
    assertions: [
  ...
  'reviews/': {
    ...
    successBody: { reviewId: 'rev_demo654', rating: 4, status: 'published', productId: 'prod_001', author: 'test-user' },
    failBody: { error: 'Forbidden', message: 'User has already reviewed this product', code: 403 },
    assertions: [
  ...
  'inventory/': {
    ...
    successBody: { productId: 'prod_001', available: 248, reserved: 2, warehouse: 'US-WEST-1', updatedAt: '2024-01-15T08:00:00Z' },
    failBody: { error: 'Service Unavailable', message: 'Inventory service is temporarily unavailable', code: 503, retryAfter: 30 },
    assertions: [
  ...
  'notifications/': {
    ...
    successBody: { messageId: 'msg_demo987', status: 'queued', channel: 'email', recipient: 'test@acme.io', scheduledAt: null },
    failBody: { error: 'Bad Gateway', message: 'SMTP relay rejected message: invalid recipient domain', code: 502 },
    assertions: [
  ...
  'search/': {
    ...
    successBody: { hits: 12, took: 4, results: [{ id: 'prod_001', score: 0.98, title: 'Demo Widget' }], page: 1, pageSize: 20 },
    failBody: { error: 'Bad Request', message: 'Query syntax error: unexpected operator near "&&"', code: 400 },
    assertions: [
  ...
  'analytics/': {
    ...
    successBody: { metric: 'page_views', value: 15432, period: '7d', change: '+12.3%', breakdown: { mobile: 8201, desktop: 7231 } },
    failBody: { error: 'Internal Server Error', message: 'Aggregation pipeline timed out after 30s', code: 500 },
    assertions: [
  ...
  'admin/': {
    ...
    successBody: { totalUsers: 1482, activeOrders: 37, revenue: 48291.50, systemHealth: 'healthy' },
    failBody: { error: 'Forbidden', message: 'Insufficient permissions: admin role required', code: 403 },
    assertions: [
...
const FRONTEND_STEP_CONFIG = {
  'components/': {
    ...
    failOutput: { rendered: false, error: 'Component failed to mount: missing required prop "onClick"' },
    assertions: [
  ...
  'pages/': {
    ...
    successOutput: { pageTitle: 'Expected Page', apiCallsMade: 2, renderTime: '142ms' },
    failOutput: { error: 'Timeout: page did not finish rendering within 3000ms', renderTime: '>3000ms' },
    assertions: [
  ...
  'navigation/': {
    ...
    setupSteps: [
      'Mount app shell with navigation components',
    ],
    actionVerb: 'Trigger navigation event and assert routing',
    successOutput: { activeRoute: '/dashboard', breadcrumbs: ['Home', 'Dashboard'], menuOpen: false },
    failOutput: { error: 'Element not found: [data-testid="nav-menu"]', selector: '[data-testid="nav-menu"]' },
    assertions: [
  ...
  'theme/': {
    suite: 'visual-suite',
    setupSteps: [
      'Initialize theme provider with default light theme',
    ],
    actionVerb: 'Toggle theme and capture visual output',
    successOutput: { theme: 'dark', cssVarsApplied: true, contrastRatio: 7.1 },
    failOutput: { error: 'Visual regression: screenshot pixel diff 3.8% exceeds threshold 2%', diff: '3.8%' },
    assertions: [
  ...
  'accessibility/': {
    suite: 'a11y-suite',
    setupSteps: [
      'Mount component/page with axe-core accessibility engine',
    ],
    actionVerb: 'Run axe accessibility audit on rendered output',
    successOutput: { violations: 0, passes: 14, incomplete: 2, axeVersion: '4.8.0' },
    failOutput: { violations: 2, rules: ['color-contrast', 'aria-required-attr'], impact: 'serious' },
    assertions: [
  ...
  'performance/': {
    ...
    failOutput: { lcp: '4.2s', fid: '180ms', cls: 0.14, score: 48, budgetExceeded: ['lcp', 'fid'] },
    assertions: [
...
const E2E_STEP_CONFIG = {
  'flows/': {
    ...
    successOutput: { flowCompleted: true, finalUrl: '/order/confirmation', screenshotSaved: true },
    failOutput: { error: 'Timeout: page.waitForSelector("#order-confirm") exceeded 30s', selector: '#order-confirm' },
    assertions: [
  ...
  'smoke/': {
    suite: 'smoke-suite',
    setupSteps: [
      'Launch browser and navigate to production base URL',
    ],
    actionVerb: 'Execute smoke check — verify page loads and responds',
    successOutput: { statusCode: 200, loadTime: '1.2s', criticalElementsVisible: true },
    failOutput: { error: 'Navigation failed: net::ERR_CONNECTION_REFUSED', url: 'https://staging.acme.io' },
    assertions: [
  ...
  'regression/': {
    ...
    successOutput: { regressionPassed: true, baseline: 'v2.3.1', current: 'v2.4.0', delta: 'none' },
    failOutput: { error: 'Regression detected: session not persisted across page reload', baseline: 'v2.3.1' },
    assertions: [
  ...
  'integration/': {
    ...
    successOutput: { servicesInvoked: ['payment-gateway', 'email-service'], allHealthy: true, latency: '340ms' },
    failOutput: { error: 'Integration point failed: email-service returned 502 Bad Gateway', service: 'email-service', code: 502 },
    assertions: [
  ...
  'cross-browser/': {
    ...
    successOutput: { browser: 'chromium', flowPassed: true, uiConsistent: true, jsErrors: 0 },
    failOutput: { error: 'CSS grid layout broken in Safari: flexbox fallback not applied', browser: 'webkit' },
    assertions: [
...
function getStepConfig(uid, type) {
  const configMap = type === 'backend' ? BACKEND_STEP_CONFIG
    : type === 'frontend' ? FRONTEND_STEP_CONFIG
    : E2E_STEP_CONFIG;
...
function generateTestData(uid, type, status, durationMs, buildNum) {
  ...
  // ── teardown ──
  const teardown = [{ detail: cfg.teardownStep || 'Clean up test resources', status: 'PASS' }];
  ...
  if (type === 'backend') {
    const reqBody = cfg.method !== 'GET' ? { testField: 'demo-value', timestamp: now } : undefined;
    const request = {
      method: cfg.method,
      url: `https://staging-api.acme.io${cfg.endpointBase}/${uid.split('/').pop()}`,
      headers: { 'Content-Type': 'application/json', 'Authorization': 'Bearer demo-token-abc123', 'X-Request-ID': `req_${buildNum}_test` },
      ...(reqBody ? { body: reqBody } : {}),
    };
    const response = {
      status: isFail ? (cfg.failBody && cfg.failBody.code ? cfg.failBody.code : 500) : 200,
      headers: { 'Content-Type': 'application/json', 'X-Response-Time': `${durationMs}ms` },
  ...
  const assertionSteps = (cfg.assertions || ['Assert result is correct']).map((detail, idx) => ({
    detail,
  ...
  const body = [
    { detail: `Prepare ${type === 'e2e' ? 'browser' : type === 'frontend' ? 'component' : 'API'} request parameters`, status: 'PASS' },
    mainBodyStep,
  ];
  if (!isFail) {
    body.push({ detail: 'Validate response against JSON schema contract', status: 'PASS' });
  }
...
async function seedProductLine(product, type, uids, stabilityKey, metaMap) {
  ...
  const relations = uids.map((uid, idx) => {
    ...
    const rel = { uid, product, type, components: [meta.component], teams: [meta.team], tags: [meta.tag] };
  ...
  for (let bi = 0; bi < NUM_BUILDS; bi++) {
    ...
    const buildEnd = new Date(buildStart.getTime() + randInt(15, 45) * 60 * 1000);
    ...
    const testDocs = uids.map(uid => {
      ...
      const { info, setup, body, teardown } = generateTestData(uid, type, st, durationMs, buildNum);
    ...
    await Build.updateOne({ _id: buildDoc._id }, {
...
async function seedInvestigatedTests() {
  const knownFailures = [
    { uid: 'payments/recurring-billing',      product: PRODUCT, type: 'backend',  causedBy: 'Defect',              state: 'INVESTIGATING' },
    { uid: 'payments/process-paypal',         product: PRODUCT, type: 'backend',  causedBy: 'External Dependency', state: 'KNOWN_ISSUE' },
    { uid: 'flows/social-login-google',       product: PRODUCT, type: 'e2e',      causedBy: 'Environment',         state: 'KNOWN_ISSUE' },
    { uid: 'integration/payment-gateway',     product: PRODUCT, type: 'e2e',      causedBy: 'Defect',              state: 'FIXED' },
    { uid: 'pages/Checkout/places-order',     product: PRODUCT, type: 'frontend', causedBy: 'Defect',              state: 'INVESTIGATING' },
    { uid: 'performance/initial-load-time',   product: PRODUCT, type: 'frontend', causedBy: 'Performance',         state: 'KNOWN_ISSUE' },
    { uid: 'cross-browser/safari-checkout',   product: PRODUCT, type: 'e2e',      causedBy: 'Compatibility',       state: 'INVESTIGATING' },
    { uid: 'analytics/conversion-rate',       product: PRODUCT, type: 'backend',  causedBy: 'Defect',              state: 'FIXED' },
  ];

  await InvestigatedTest.deleteMany({ product: PRODUCT });
  await InvestigatedTest.insertMany(knownFailures.map(f => ({
    uid: f.uid,
    product: f.product,
    type: f.type,
    ...
    customize_state: {
      label: f.state,
      color: f.state === 'FIXED' ? '#22c55e' : f.state === 'KNOWN_ISSUE' ? '#f59e0b' : '#3b82f6',
    },
    failure: { error_message: pick(BACKEND_ERRORS) },
    comments: [{
      userId: ADMIN_USER_ID,
      user: 'admin',
      time: new Date(Date.now() - randInt(1, 10) * 24 * 60 * 60 * 1000),
      message: f.state === 'FIXED' ? 'Fixed in latest release.' : 'Under investigation — tracking in issue tracker.',
      isDeleted: false,
    }],
  })));

  console.log(`\n  ✓ ${knownFailures.length} investigated tests`);
}
...
async function seedSetting() {
  const doc = {
    ...
    product_line: {
      'Acme Backend':  { product: PRODUCT, type: 'backend' },
      'Acme Frontend': { product: PRODUCT, type: 'frontend' },
      'Acme E2E':      { product: PRODUCT, type: 'e2e' },
    },
    investigated_setting: {
      customize_state: [
        { label: 'INVESTIGATING',  key: 'INVESTIGATING',  color: '#3b82f6', ttl: 30 },
        { label: 'KNOWN_ISSUE',    key: 'KNOWN_ISSUE',    color: '#f59e0b', ttl: 90 },
        { label: 'FIXED',          key: 'FIXED',          color: '#22c55e', ttl: 7  },
      ],
    },
    relations_filter: [
      'components', 'teams', 'tags',
      {
        type: 'Feature', name: 'Feature', isGroup: true,
        itemList: [
      ...
      {
        type: 'Priority', name: 'Priority', isGroup: true,
        itemList: [
      ...
      {
        type: 'Browser', name: 'Browser', isGroup: true,
        itemList: [
      ...
      {
        type: 'Device', name: 'Device', isGroup: true,
        itemList: [
...
const STATUS_PATTERN = {
  status: { all: true, rerun: false, pass: false, fail: false, skip: false, ki: false, out: false, not_pass: false }
};
const RELATION_PATTERN_COMPONENTS = { ...STATUS_PATTERN, groupByRelation: 'components' };
      ...
      widgets: [
        {
          ...
          cols: 10, rows: 2, x: 0, y: 0,
          minItemCols: 4, minItemRows: 2,
        ...
        },
        {
          ...
          cols: 10, rows: 1, x: 0, y: 5,
        },
        {
          name: 'Backend Components Treemap',
          type: 'TREEMAP_TEST_RELATION',
          cols: 10, rows: 4, x: 0, y: 6,
          minItemCols: 4, minItemRows: 3,
          product_line_query: plq('backend'),
    ...
    // 2 – Backend Deep Dive
    {
      ...
      widgets: [
        ...
        },
        {
          ...
          cols: 10, rows: 5, x: 0, y: 5,
          minItemCols: 4, minItemRows: 4,
          product_line_query: plq('backend'),
          pattern: RELATION_PATTERN_COMPONENTS,
        },
      ],
    ...
    // 3 – Quality Summary
    {
      ...
      widgets: [
        ...
        },
        {
          name: '─────────────────',
          type: 'SECTION_DIVIDER',
          cols: 10, rows: 1, x: 0, y: 3,
        },
        {
          name: 'Unstable Tests',
          type: 'UNSTABLE_TESTS_TABLE',
          cols: 5, rows: 3, x: 0, y: 4,
          minItemCols: 3, minItemRows: 2,
          product_line_query: plq('backend'),
          pattern: STATUS_PATTERN,
        },
    ...
    // 4 – E2E & Frontend Relations
    {
      ...
      widgets: [
        ...
        },
        {
          ...
          type: 'TREEMAP_TEST_RELATION',
          cols: 5, rows: 5, x: 5, y: 5,
          minItemCols: 3, minItemRows: 3,
          product_line_query: plq('frontend'),
          pattern: RELATION_PATTERN_COMPONENTS,
        },
      ],
...
async function main() {
  ...
  await seedProductLine(PRODUCT, 'backend',  BACKEND_UIDS,  'backend',  BACKEND_META);
  ...
  console.log('   Dashboards: Executive Overview, Backend Deep Dive, Quality Summary, E2E & Frontend Relations\n');
